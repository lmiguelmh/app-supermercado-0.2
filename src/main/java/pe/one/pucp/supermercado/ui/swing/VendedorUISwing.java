...
public class VendedorUISwing
        extends AbstractGenericUI<Vendedor>
        implements VendedorUI {
    ...
    @Override
    public Vendedor getFromUI() {
        Vendedor vendedor = new Vendedor();
        vendedor.setCoVendedor(codigoTextField.getText());
        vendedor.setEsVendedor(estadoCheckBox.isSelected() ? "1" : "0");
        vendedor.setNoVendedor(nombreTextField.getText());
        return vendedor;
    }

    @Override
    public void setToUI(Vendedor vendedor) {
        codigoTextField.setText(vendedor.getCoVendedor());
        estadoCheckBox.setSelected("1".equals(vendedor.getEsVendedor()));
        nombreTextField.setText(vendedor.getNoVendedor());
    }

    @Override
    public void resetUI() {
        setToUI(new Vendedor());
    }
