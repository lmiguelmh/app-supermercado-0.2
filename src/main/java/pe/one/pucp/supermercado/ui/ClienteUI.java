...
import pe.one.pucp.supermercado.controller.ClienteUIController;
...
public class ClienteUI {
    ...
    @Autowired
    ClienteUIController controller;
    ...
    public void setClasificacion(String clasificacion) {
        clasificacionTextField.setText(clasificacion);
    }
    ...
    public String getClasificacion() {
        return clasificacionTextField.getText();
    }
    ...
    public Object getSelectedCodigo() {
        ...
        if (row >= 0) {
            return clienteTable.getModel().getValueAt(getSelectedRow(), 0);
        }
        return null;
    }
